  ...
  <div class="widget-body">
    <ul>
            ...
            <?php while($comments->next()): ?>
                <li><a href="<?php $comments->permalink(); ?>"><?php
...
if ( !is_file($e) || (time() - filemtime($e)) > $t ){//當頭像不存在或文件超過14天才更新
  $g = 'http://www.gravatar.com/avatar/' . $f . '?s=30&d=' . $d . '&r=X';
...
<?php if($this->is('index')): ?>
  <div class="widget">
    <h3 class="widget-title"><i class="icon-link"></i>Designs</h3>
  <div class="widget-body">
    <ul>
      <li><a href="http://www.cssbasics.com/" target="_blank">CSS Basics</a></li>
      <li><a href="http://www.smashingmagazine.com/" target="_blank">Smashing Magazine</a></li>
      <li><a href="http://maxvoltar.com/" target="_blank">Maxvoltar</a></li>
      ...
      <li><a href="http://vandelaydesign.com/blog/" target="_blank">Vandelay Design Blog</a></li>
      ...
      <li><a href="http://10steps.sg/" target="_blank">10Steps.SG</a></li>
    </ul>
  </div>
  </div>
  <?php endif; ?>
