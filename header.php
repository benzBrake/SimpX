...
<head profile="http://gmpg.org/xfn/11">
    ...
    <![endif]-->
    <!--[if IE 6]>
	<script src="<?php $this->options->themeUrl('/assets/js/DD_belatedPNG.js'); ?>"></script>
	<script>
	...
	<![endif]-->
    <!--[if IE]>
	<link rel="stylesheet" media="screen" href="<?php $this->options->themeUrl('assets/css/ie.css'); ?>" />
	<![endif]-->
