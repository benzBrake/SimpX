...
<div
	<article id="post-<?php $this->cid() ?>" class="post entry box" itemprop="blogPost" itemscope itemtype="http://schema.org/BlogPosting">
		<?php if($this->is('page')) { ?>
        ...
        <ul class="clearfix">
            ...
            <li>
				<a href="<?php echo $v['url'];?>" target="_blank">
					...
					<div class="rsp"><div class="text"><h3><?php echo $v['name'];?></h3></div></div>
				</a>
			</li>
            <?php } ?>
         </ul>
